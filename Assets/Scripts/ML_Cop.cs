...
public class ML_Cop : Agent
{
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        sensor.AddObservation(criminal.position);
        sensor.AddObservation(Vector3.Distance(transform.position, criminal.position));
    ...
    public override void OnActionReceived(ActionBuffers actions)
    {
        ...
        if (Vector3.Distance(transform.position, criminal.position) < radius)
        {
            SetReward(20f);
            EndEpisode();
        }
