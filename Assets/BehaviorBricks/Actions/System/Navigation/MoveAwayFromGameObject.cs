...
namespace BBUnity.Actions
{
    ...
    public class MoveAwayFromGameObject : GOAction
    {
        ...
        [InParam("target")]
        [Help("Target game object towards this game object will flee")]
        ...
        public override void OnStart()
        {
			...
			navAgent.SetDestination(-(targetTransform.position - gameObject.transform.position).normalized + gameObject.transform.position);
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            else if (navAgent.destination != -(targetTransform.position - gameObject.transform.position).normalized + gameObject.transform.position)
                navAgent.SetDestination(-(targetTransform.position - gameObject.transform.position).normalized + gameObject.transform.position);
